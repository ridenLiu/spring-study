...
import com.riden.framework.beans.factory.*;
...
import com.riden.framework.beans.factory.config.BeanReference;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    //    private InstantiationStrategy_ instantiationStrategy = new CglibSubclassingInstantiationStrategy();
    ...
    protected Object createBean(String beanName, BeanDefinition beanDefinition, Object[] args) throws BeansException {
        ...
        // 注册实现了 DisposableBean 接口的 Bean 对象 (销毁函数)
    ...
    private void invokeInitMethods(String beanName, Object bean, BeanDefinition beanDefinition) throws Exception {
        ...
        if (!StrUtil.isNotEmpty(initMethodName)) return;
        try {
