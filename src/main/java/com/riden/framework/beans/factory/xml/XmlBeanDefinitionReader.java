package com.riden.framework.beans.factory.xml;
...
import com.riden.framework.beans.factory.support.AbstractBeanDefinitionReader;
import com.riden.framework.beans.factory.support.BeanDefinitionRegistry;
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            for (int j = 0; j < bean.getChildNodes().getLength(); j++) {
                ...
                Object value = StrUtil.isNotEmpty(attrRef) ? new RuntimeBeanNameReference(attrRef) : attrValue;
